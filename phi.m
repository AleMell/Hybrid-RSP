...
% The map Phi defining the update rule for the set of directions
% \mathcal(G), possibly constructing, if the condition on the determinant
% is satisfied, a set of conjugate directions.
